...
gui.add(walls.material, 'aoMapIntensity').min(0).max(10).step(.01)
...
gui.add(door.material, 'aoMapIntensity').min(0).max(10).step(.01)


door.geometry.setAttribute('uv2', new THREE.Float32BufferAttribute(door.geometry.attributes.uv.array, 2))

door.position.y = door.geometry.parameters.height/2 - .2;
// z figting
